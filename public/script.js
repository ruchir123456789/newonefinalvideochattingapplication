...
const particpents = document.querySelector('#particepents');
var parts =prompt("enter your name");  
// array.push(parts)


function particepentadding(parts){
const div = document.createElement('div')
div.innerText = parts;
div.setAttribute("class",'part')
div.setAttribute("id",'part')
particpents.append(div)
console.log(parts);

}

//  particepentadding(parts)
